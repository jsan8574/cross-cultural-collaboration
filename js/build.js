...
const Build = (() => {
  ...
  const BIAS = {
    ...
    high: [
      ...
      { mono:'03', name:'Reporting a team that has no faces',
        front:'Attributing everything to "the team". It is generous and it is taken literally — no individual on your team enters the record, so none of them is visible when opportunities are decided.',
        back:'Report the collective result and then name people: "the team cleared the backlog — Priya rebuilt the follow-up sequence for secondaries." You keep the harmony and give your people a track record.',
        coach:'Your reports cannot do this for themselves without breaching their own norms. You can do it for them without breaching anything. That asymmetry is the whole argument.' },
      { mono:'04', name:'Waiting to be asked',
        front:'Holding a view, a risk or a resourcing problem until someone invites it — and treating the absence of a question as a boundary rather than an oversight.',
        back:'"I want to flag one thing before we commit" is a completely safe opening in a direct register. Use it before you are asked, on behalf of your team.',
        coach:'The absence of a request is read as the absence of a concern. Your team is relying on you to spend the standing you have.' },
      { mono:'05', name:'Passing on a misread',
        front:'Hearing a short reply or a direct correction as anger, then transmitting that reading to your team — who now brace for a problem that was never there.',
        back:'Check before you relay: "just so I read that right — is that a concern about the work, or about how we are working together?" Then tell your team what it actually was.',
        coach:'You are the filter. An anxious reading of a neutral message does not stop with you — it reaches everyone who reports to you.' },
    ...
    const blocks = [
      ...
      { type:'activity', activity:{
        ...
        intro: youLow
          ...
          : `Your ${t.the} counterpart has asked for a full AR sweep on 600 accounts by Friday. You have walked it through with your team: it cannot be done properly by Friday. Doing it badly by Friday is possible. It is Tuesday.`,
        nodes: youLow ? [
          ...
          { id:'n1', prompt:'What do you do on Tuesday?',
            options:[
              ...
              { text:'Say on Tuesday: "Friday is not achievable at our quality standard. My team can do 350 accounts properly by Friday, or all 600 by Wednesday next week. Which serves the client better?"', ok:true,
          ...
          { id:'n2', prompt:'They reply: "It has to be Friday, the client committed." What now?',
            options:[
              ...
              { text:'Ask: "understood. Then help me prioritise — if any are approaching timely-filing limits, I will put the team on those first."', ok:true,
  ...
  function buildCourse(youId, themIds){
    ...
    return {
      ...
      subtitle: `For managers and senior leaders based in ${you.the}, working with ${listNames(them)}`,
      passMark: 75,
      modules,
